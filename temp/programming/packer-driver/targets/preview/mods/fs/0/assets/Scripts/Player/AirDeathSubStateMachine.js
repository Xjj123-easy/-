System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, AirDeathSubStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a9a39IVSkZI2JffLv+5fVSs", "AirDeathSubStateMachine", undefined);

      BaseUrl = 'texture/player/airdeath';

      _export("default", AirDeathSubStateMachine = class AirDeathSubStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
