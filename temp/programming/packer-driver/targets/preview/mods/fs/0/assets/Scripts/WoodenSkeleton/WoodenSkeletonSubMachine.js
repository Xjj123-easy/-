System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Animation, ENTINY_STATE_ENUM, PARAMS_NAME_ENUM, EnityManger, GetParamsNUmber, GetParamsTrigger, StateMachine, AttackSubStateMachines, DeathSubStateMachines, IdleSubStateMachines, _dec, _class, _crd, ccclass, property, WoodenSkeletonSubMachine;
  ...
  function _reportPossibleCrUseOfAttackSubStateMachines(extras) {
    _reporterNs.report("AttackSubStateMachines", "./AttackSubStateMachines", _context.meta, extras);
  }

  function _reportPossibleCrUseOfDeathSubStateMachines(extras) {
    _reporterNs.report("DeathSubStateMachines", "./DeathSubStateMachines", _context.meta, extras);
  }

  function _reportPossibleCrUseOfIdleSubStateMachines(extras) {
    _reporterNs.report("IdleSubStateMachines", "./IdleSubStateMachines", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      AttackSubStateMachines = _unresolved_5.default;
    }, function (_unresolved_6) {
      DeathSubStateMachines = _unresolved_6.default;
    }, function (_unresolved_7) {
      IdleSubStateMachines = _unresolved_7.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "da52d/AWolMwancqN1oVRW7", "WoodenSkeletonSubMachine", undefined);
      ...
      _export("WoodenSkeletonSubMachine", WoodenSkeletonSubMachine = (_dec = ccclass('WoodenSkeletonSubMachine'), _dec(_class = class WoodenSkeletonSubMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        error: Error()
        ...
        initStateMachine() {
          this.stateMachine.set((_crd && PARAMS_NAME_ENUM === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_ENUM({
            error: Error()
          }), PARAMS_NAME_ENUM) : PARAMS_NAME_ENUM).IDLE, new (_crd && IdleSubStateMachines === void 0 ? (_reportPossibleCrUseOfIdleSubStateMachines({
            error: Error()
          }), IdleSubStateMachines) : IdleSubStateMachines)(this));
          this.stateMachine.set((_crd && PARAMS_NAME_ENUM === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_ENUM({
            error: Error()
          }), PARAMS_NAME_ENUM) : PARAMS_NAME_ENUM).ATTACK, new (_crd && AttackSubStateMachines === void 0 ? (_reportPossibleCrUseOfAttackSubStateMachines({
            error: Error()
          }), AttackSubStateMachines) : AttackSubStateMachines)(this));
          this.stateMachine.set((_crd && PARAMS_NAME_ENUM === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_ENUM({
            error: Error()
          }), PARAMS_NAME_ENUM) : PARAMS_NAME_ENUM).DEATH, new (_crd && DeathSubStateMachines === void 0 ? (_reportPossibleCrUseOfDeathSubStateMachines({
            error: Error()
          }), DeathSubStateMachines) : DeathSubStateMachines)(this));
        }
...
//# sourceMappingURL=WoodenSkeletonSubMachine.js.map