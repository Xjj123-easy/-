      ...
      _export("BurstManager", BurstManager = (_dec = ccclass('BurstManager'), _dec(_class = class BurstManager extends (_crd && EnityManger === void 0 ? (_reportPossibleCrUseOfEnityManger({
        ...
        init(params) {
          ...
          return _asyncToGenerator(function* () {
            _this.fsm = _this.addComponent(_crd && BurstMachine === void 0 ? (_reportPossibleCrUseOfBurstMachine({
              error: Error()
            ...
            _this.transfrom.setContentSize(_crd && TILE_WIDTH === void 0 ? (_reportPossibleCrUseOfTILE_WIDTH({
              error: Error()
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), EVENTMANAGER) : EVENTMANAGER).PLAYERMOVE_END, _this.onBurst, _this);
          })();
        }
