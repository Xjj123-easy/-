System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, BlockturnleftStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7611bvbz7NMHq5XoKxq3OTx", "BlockturnleftStateMachine", undefined);

      BaseUrl = 'texture/player/blockturnleft';

      _export("default", BlockturnleftStateMachine = class BlockturnleftStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=BlockturnleftStateMachine.js.map