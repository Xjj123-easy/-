System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, IronskeletonDeathsubMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b88bckrjQ5KQZzPFmTDKb7I", "IronskeletonDeathsubMachine", undefined);

      BaseUrl = 'texture/ironskeleton/death';

      _export("default", IronskeletonDeathsubMachine = class IronskeletonDeathsubMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
        ...
        constructor(fsm) {
          ...
          this.stateMachine.set((_crd && DRIECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDRIECTION_ENUM({
            ...
            error: Error()
          }), State) : State)(fsm, BaseUrl + "/bottom"));
          this.stateMachine.set((_crd && DRIECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDRIECTION_ENUM({
            error: Error()
...
//# sourceMappingURL=IronskeletonDeathsubMachine.js.map