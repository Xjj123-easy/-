    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = class EnemyManager extends (_crd && EnityManger === void 0 ? (_reportPossibleCrUseOfEnityManger({
        ...
        init(params) {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), EVENTMANAGER) : EVENTMANAGER).PLAYERMOVE_END, _this.changeDirection, _this);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).Instance.on((_crd && EVENTMANAGER === void 0 ? (_reportPossibleCrUseOfEVENTMANAGER({
              error: Error()
            }), EVENTMANAGER) : EVENTMANAGER).PLAYER_BORN, _this.changeDirection, _this);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).Instance.on((_crd && EVENTMANAGER === void 0 ? (_reportPossibleCrUseOfEVENTMANAGER({
              error: Error()
            }), EVENTMANAGER) : EVENTMANAGER).ATTACK_ENEMY, _this.onDead, _this);

            _this.changeDirection(true);
          })();
        }
        ...
        changeDirection(isInit) {
          ...
          var dix = Math.abs(this.x - playerX);
          var diy = Math.abs(this.y - playerY);
