System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, SPIKES_COUNT_ENUM, State, SpikesSubMachine, SpikesTwoSubMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "aec46pdkExHMbyuAa3rGT5d", "SpikesTwoSubMachine", undefined);

      BASE_URL = 'texture/spikes/spikestwo';

      _export("default", SpikesTwoSubMachine = class SpikesTwoSubMachine extends (_crd && SpikesSubMachine === void 0 ? (_reportPossibleCrUseOfSpikesSubMachine({
        error: Error()
...
//# sourceMappingURL=SpikesTwoSubMachine.js.map