System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, DoorDeathSubStateMachines, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3d0dcEsVLBPKbTWVt7mzdQy", "DoorDeathSubStateMachines", undefined);

      BaseUrl = 'texture/door/death';

      _export("default", DoorDeathSubStateMachines = class DoorDeathSubStateMachines extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=DoorDeathSubStateMachines.js.map