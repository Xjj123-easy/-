System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, BlockfrontStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ebb95P0ckdErY9PdTxVMEhV", "BlockfrontStateMachine%20copy", undefined);

      BaseUrl = 'texture/player/blockfront';

      _export("default", BlockfrontStateMachine = class BlockfrontStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=BlockfrontStateMachine copy.js.map