    ...
    execute: function () {
      ...
      _export("default", FaderManager = class FaderManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        get fader() {
          ...
          const root = (_crd && creatUINode === void 0 ? (_reportPossibleCrUseOfcreatUINode({
            error: Error()
          }), creatUINode) : creatUINode)();
          root.addComponent(RenderRoot2D);
          const faderNode = (_crd && creatUINode === void 0 ? (_reportPossibleCrUseOfcreatUINode({
            error: Error()
          }), creatUINode) : creatUINode)();
        ...
        fadeIn(duration = _crd && DURATION === void 0 ? (_reportPossibleCrUseOfDURATION({
          error: Error()
        }), DURATION) : DURATION) {
          return this.fader.fadeIn(duration);
        }

        fadeOut(duration = _crd && DURATION === void 0 ? (_reportPossibleCrUseOfDURATION({
          error: Error()
        }), DURATION) : DURATION) {
