System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, BlockturnrightStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "471baDN00lHwoHfqT1qcPff", "BlockturnrightStateMachine", undefined);

      BaseUrl = 'texture/player/blockturnright';

      _export("default", BlockturnrightStateMachine = class BlockturnrightStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=BlockturnrightStateMachine.js.map