  ...
  return {
    ...
    execute: function () {
      ...
      _export("WoodenSkeletonManager", WoodenSkeletonManager = (_dec = ccclass('WoodenSkeletonManager'), _dec(_class = class WoodenSkeletonManager extends (_crd && EnemyManager === void 0 ? (_reportPossibleCrUseOfEnemyManager({
        ...
        async init(params) {
          this.fsm = this.addComponent(_crd && WoodenSkeletonSubMachine === void 0 ? (_reportPossibleCrUseOfWoodenSkeletonSubMachine({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EVENTMANAGER) : EVENTMANAGER).PLAYERMOVE_END, this.onAttack, this);
        }
