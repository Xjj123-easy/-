System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, BlockblackStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "89ef1ycB/dONogNorY5TOcc", "BlockblackStateMachine", undefined);

      BaseUrl = 'texture/player/blockback';

      _export("default", BlockblackStateMachine = class BlockblackStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=BlockblackStateMachine.js.map