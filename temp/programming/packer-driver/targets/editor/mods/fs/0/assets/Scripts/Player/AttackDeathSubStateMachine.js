System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, AttackDeathSubStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f79f1TAtitDuJM6SJhplKEY", "AttackDeathSubStateMachine", undefined);

      BaseUrl = 'texture/player/death';

      _export("default", AttackDeathSubStateMachine = class AttackDeathSubStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=AttackDeathSubStateMachine.js.map