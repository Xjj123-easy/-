System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, SPIKES_COUNT_ENUM, State, SpikesSubMachine, SpikesThreeSubMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "a5e1evtdiVAyIBRO0EZxzIC", "SpikesThreeSubMachine", undefined);

      BASE_URL = 'texture/spikes/spikesthree';

      _export("default", SpikesThreeSubMachine = class SpikesThreeSubMachine extends (_crd && SpikesSubMachine === void 0 ? (_reportPossibleCrUseOfSpikesSubMachine({
        error: Error()
...
//# sourceMappingURL=SpikesThreeSubMachine.js.map