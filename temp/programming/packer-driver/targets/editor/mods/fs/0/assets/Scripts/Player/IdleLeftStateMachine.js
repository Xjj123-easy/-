System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, AnimationClip, IdleTurnStateMachie, IdleLeftStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "75067V6Ub9JQ4eao9G0+f4F", "IdleLeftStateMachine", undefined);

      BaseUrl = 'texture/player/idle';

      _export("default", IdleLeftStateMachine = class IdleLeftStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=IdleLeftStateMachine.js.map