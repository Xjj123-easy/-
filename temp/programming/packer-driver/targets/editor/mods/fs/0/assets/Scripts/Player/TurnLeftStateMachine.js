System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DRIECTION_ENUM, State, IdleTurnStateMachie, TurnLeftStateMachine, _crd, BaseUrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "007d6jPZUNDPI/OrXcQLd38", "TurnLeftStateMachine", undefined);

      BaseUrl = 'texture/player/turnleft';

      _export("default", TurnLeftStateMachine = class TurnLeftStateMachine extends (_crd && IdleTurnStateMachie === void 0 ? (_reportPossibleCrUseOfIdleTurnStateMachie({
        error: Error()
...
//# sourceMappingURL=TurnLeftStateMachine.js.map